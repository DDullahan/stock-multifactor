...
# 初始化：注册数据和设置参数
def init(context):
    set_backtest(initial_cash=1e6) #初始化设置账户总资金
    ...
    # reg_userdata(timeline=['2018-01-31', '2018-02-01'], data=[2.6, 3.8])
...
def on_data(context):
    ...
    #获取标的序tframe.uclass.MinListWrapper object 号：
    ...
    # user_data_temp = get_reg_userdata(reg_idx=context.reg_userdata[0], length=1)
...
if __name__ == '__main__':
    #回测函数：
    strategy_id = run_backtest(strategy_name='ThreeLines', file_path='.', target_list=get_code_list('sz50')['code'],
                 frequency='day', fre_num=1, begin_date='2014-12-30', end_date='2018-11-30', fq=1)
    print("strategy_id:", strategy_id)
# if __name__ == '__main__':
#     run_backtest(strategy_name='ThreeLines', file_path='.', target_list=['sse.600000'], frequency='min', fre_num=120, begin_date='2018-01-30', end_date='2018-06-30')
